                                        ...
                                        <div class="card-header py-3">
                                            <div class="row">
                                               <div class="col-12"> 
                                                    ...
                                                    فاتورة مبيعات ضريبية لشركة او مؤسسة
                                                    </h4> 
                                                </div> 
                                            </div>  
                                        </div>
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-5">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control"
                                                            ...
                                                            <option value="2" >{{__('ذهب صافي')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                               <div class="col-lg-1  pull-right"> 
                                                     <div class="form-group"> 
                                                        ...
                                                        @can('اضافة عميل')  
                                                            <a class="btn btn-info pd-x-20 get_details" data-toggle="modal" href="#createModal"> 
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modelTitle"> {{ __('main.create_client')  }}</label>
            ...
            <div class="modal-body" id="paymentBody">
                <form   method="POST" action="{{ route('storeCompany') }}"
                    ...
                    @csrf
                    <input type="hidden" name="postax" value="1"/>  
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    var sItems = {};
    var count = 1; 
    document.title = "فاتورة مبيعات ضريبية";
    ...
    function getBillNo() {
        ...
        $.ajax({
            type: 'get',
            url: 'get_sales_pos_tax_no/1/' + type+ '/' + branch_id,
            dataType: 'json',
            success: function (response) {
                console.log(response);
