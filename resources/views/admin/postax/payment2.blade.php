        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="smallBody"> 
                        ...
                        <div class="col-md-6"  style="display: block; margin: auto;">
                            <div class="form-group">
                                ...
                                <input required type="text"   id="money" name="money"
                                       class="form-control text-center" readonly value="{{$money - $amount}}" />
                    ...
                    <div class="row"> 
                        <div class="col-md-4" >
                            <div class="form-group">
                                <label>{{__('النقدية المسددة')}} <span style="color:red; font-size:20px; font-weight:bold;">*</span> </label>
                                <input required type="number" id="amount" name="amount" min="0" step="any"
                                       class="form-control"  value="{{$amount}}" readonly/>
                            </div>
                        </div>
                        <div class="col-md-4" >
                            <div class="form-group">
