                    ...
                    <div class="row">
                        <div class="card shadow mb-4 col-9">
                            <div class="card-header py-3">
                                ...
                                <a href="{{route('oldEnterPrint' , $bill -> id)}}" class="btn btn-primary" role="button" data-bs-toggle="button">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="supplier_id" name="supplier_id" disabled>
                                                ...
                                                @foreach($vendors as $vendor)
                                                    <option value="{{$vendor -> id}}" @if($vendor -> id == $bill -> client_id) selected @endif >{{$vendor -> name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card shadow mb-4 col-3">
                            ...
                            <div class="card-body">
                                <div class="row" style="align-items: center; margin-bottom: 10px;">
                                    ...
                                    <div class="col-6">
                                        ...
                                        @foreach($details as $item)
                                                ...
                                                <?php $sum_weight21 += $item -> weight21 ?>
                                ...
                                <div class="row" style="align-items: center; margin-bottom: 10px;">
                                    ...
                                    <div class="col-6">
                                        <input type="text" readonly class="form-control"
                                               id="total_weight21" value="{{$sum_weight21}}">
                                    </div>
                                </div>
                                ...
                                <div class="row" style="align-items: center; margin-bottom: 10px;" >
                                    ...
                                    <div class="col-6">
                                        <input type="text" readonly class="form-control"  id="net_sales" value="{{$bill -> total_money}}">
                                    </div>
                                </div>
                                ...
                                <div class="row" style="align-items: baseline; margin-bottom: 10px;" >
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any"  class="form-control" id="discount" name="discount" readonly value="{{$bill -> discount}}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly  class="form-control" id="net_after_discount" name="net_after_discount" placeholder="0" value="{{$bill -> net_money}}">
                                        </div>
                                    </div>
                                </div>
