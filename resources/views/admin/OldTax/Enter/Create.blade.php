                                               ...
                                               <div class="controls table-controls">
                                                   <table id="sTable" class="table items table-striped table-bordered table-condensed table-hover">
                                                       ...
                                                       <tr>
                                                           ...
                                                           <th class="text-center" hidden>{{__('main.price_gram')}}</th>
  ...
  $(document).ready(function (){
     ...
     $('#createButton').click(function (){
      ...
      $(document).on('change','.iQuantity',function () {
          ...
          const price = row[0].cells[2].firstChild.value;
          const total = price * $(this).val() ;
          row[0].cells[4].firstChild.value = weight21 ;
          row[0].cells[7].firstChild.value = $(this).val()  ;
          row[0].cells[6].firstChild.value = total  ;
          console.log(price);
          calcTotals();
      });
  ...
  function is_numeric(mixed_var) {
    ...
    function AddRowToTable(karat){
        ...
        if(!repeate) {
            ...
            cell11.innerHTML = '<input name="gram_price[]" value="'+karat.price.toFixed(2)+'" class="form-control" readonly>';
