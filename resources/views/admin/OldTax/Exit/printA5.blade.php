        ...
        <div class="row" id="" style="direction:rtl">
            ...
            <div class="col-4 text-left">
                <div class="visible-print text-left mt-1">
                    ...
                    ?>
                    <img src="{{$displayQRCodeAsBase64}}" style="width: 50px; height: 50px;" alt="QR Code"/>
                </div>
            </div>
        ...
        <table style="width: 100% ; direction: rtl" class="table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-center " >سعر الجرام
                        <br>(Gram Price) </th>
                    <th class="text-center " >الوزن 
                        <br>(Weight)</th>
                    <th class="text-center " >وزن ما يعادل 21
                        <br>(Weight*21)</th>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="3">المجموع
                        <br>(Sub Total)</td>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="3">الخصم
                        <br>(Discount Value)
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="3"> ضريبة القيمة المضافة  (Vat)
                    </td>
                </tr>
                <tr>
