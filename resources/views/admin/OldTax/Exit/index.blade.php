                ...
                <div class="card-header pb-0">
                    <div class="col-lg-12 margin-tb">
                        <h4  class="alert alert-primary text-center">
                            {{__('main.old_gold_exit_list')}}
                        </h4>
                    </div>
                    <div class="clearfix"></div>
                </div> 
                    <a href="{{route('oldExitCreate')}}"
                                ...
                                <table class="display w-100  text-nowrap table-bordered" id="example1" 
                                   style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-md-center font-weight-bolder opacity-7" hidden> {{__('main.remain_weight21')}} </th>
                                    ...
                                    @foreach($data as $bill)
                                        <tr>
                                            ...
                                            <td class="text-center" hidden>{{$bill -> remain_gold}}</td>
                                            <td class="text-center">
                                                <a href="{{route('oldExitPreview' , $bill -> id)}}">
...
<script type="text/javascript">
    ...
    function confirmDelete() {
        let url = "{{ route('oldExitDelete', ':id') }}";
