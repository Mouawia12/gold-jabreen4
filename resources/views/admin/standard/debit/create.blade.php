                ...
                <div class="card">
                    <div class="card-header pb-0"  id="head-right" >
                        <div class="col-lg-12 margin-tb">
                            ...
                            [ {{ __('اضافة اشعار مدين لفاتورة ضريبية') }} ]
                            </h4>
                        </div>
                        <div class="clearfix"></div>
                    </div> 
                    <div class="card-body pt-0 pb-2">
                        <form id="formSales" method="POST" action="{{ route('store.standard.dept',$id) }}"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function getBillNo(){
          ...
          $.ajax({
                type:'get', 
                url:'{{route('get.standard.debit.no',[2,$sale->branch_id])}}',
                dataType: 'json',
    ...
    function loadItems(){ 
      ...
      $.each(sItems,function (i,item) {
          ...
          if(item.weight > 0) {
                ...
                tr_html += '<td hidden><input type="hidden" class="form-control" readonly name="standard_detail_id[]" value="' + item.id + '"></td>';
