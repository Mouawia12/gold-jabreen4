...
<script type="text/javascript">
    ...
    function loadItems() {
        ...
        $.each(sItems, function (i, item) {
            ...
            tr_html += '<td><input type="hidden" class="form-control iNewkarat" name="karat_id[]" value="' + item.karat_id + '"> <span>' + item.karat.name_ar + '</span> </td>';
            ...
            tr_html += '<td><input type="text"  class="form-control iNewTotalWithTax" name="net_money[]" value=" ' +  ((item.weight * item.price) +  (item.weight * item.price  * (item.karat.stamp_value / 100) )).toFixed(2)  +' " ></td>';
