...
<head>
    <title>
    مرتجع فاتورة ضريبة مبسطة  رقم {{$bill -> bill_number}}
    </title>
    <meta charset="utf-8"/>
        ...
        <div class="row" id="" style="direction:rtl">
            ...
            <div class="col-4 text-center">
                <h4 class="text-center mt-1" style="font-weight: bold;">
                    <strong>مرتجع فاتورة ضريبية مبسطة</strong> 
                </h4>
            </div>
        ...
        <table style="width: 100% ; direction: rtl" class="table-bordered">
            ...
            @foreach($details as $detail)
                <tr>
                    ...
                    <td class="text-center"> {{number_format($detail -> weight  * ($detail -> gram_price + $detail -> gram_manufacture),2)}} </td>
                    <td class="text-center"> {{$detail -> gram_tax }} </td>
                    <td class="text-center"> {{number_format($detail -> net_money,2)}} </td>
                </tr>
            @endforeach

            <tr>
                <td class="text-center"  colspan="2">{{number_format(($bill -> net_money - $bill -> tax) * -1,2)}}</td>
            ...
            <tr>
                <td class="text-center"  colspan="2">{{number_format($bill -> tax * -1,2)}}</td>
                <td class="text-center" colspan="3"> ضريبة القيمة المضافة  (Add Value Vat)
                </td> 
                <td class="text-center" colspan="3" rowspan="3" >  </td>
            </tr>
            <tr>
                <td class="text-center"  colspan="2">{{number_format($bill -> net_money * -1,2)}}</td>
