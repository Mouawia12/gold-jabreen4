            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        ...
                        <button aria-label="Close" class="cancel-modal"
                    ...
                    <form action="{{ route('admin.admins.destroy', 'test') }}" method="post">
                        ...
                        <div class="modal-footer">
                            <button id ="btn-cancel" type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
...
<script>
    $(document).ready(function () {
        ...
        $('#example-table tfoot tr th:nth-child(5)').html('<select id="roles" class="form-control">@foreach($roles as $role)<option value="{{$role}}">{{$role}}</option>@endforeach</select>');
