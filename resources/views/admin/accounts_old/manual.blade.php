    ...
    function loadItems(){
        ...
        $.each(sItems,function (i,item) {
            ...
            if(level == item.level){
                ...
                var tr_html ='<td class="text-center"><input type="hidden" name="level[]" value="'+item.level+'"> <span>'+item.level+'</span> </td>';
                
                tr_html +='<td class="text-center"><input type="hidden" name="account_id[]" value="'+item.id+'"> <span>'+item.code+'</span> </td>';
                tr_html +='<td class="text-center">'+item.name+'</td>';
                tr_html +='<td class="text-center"><input type="text" class="form-control text-center iDebit" name="debit[]" value="'+item.debit.toFixed(2)+'"></td>';
                tr_html +='<td class="text-center"><input type="text" class="form-control text-center iCredit" name="credit[]" value="'+item.credit.toFixed(2)+'"></td>'; 
