            ...
            <section class="invoice">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-4 invoice-col">  
                  <address> 
                    <h4 class="page-header">
                      <strong>  فاتورة مشتريات ذهب </strong> 
                      <br>
                       [ كسر / صافي ]
                    </h4>
                  </address>
                ...
                <div class="col-4 invoice-col text-left">
                  ...
                  <b> الضريبى :</b>  {{$company ->taxNumber}}<br>
              ...
              <!-- /.row --> 
                <div class="col-12">
                  <hr> 
                  <h5><strong>المورد : </strong>{{$bill -> vendor_name != 'عميل نقدي افتراضي'  ?$bill -> vendor_name : '............' }}</h5> 
                  @if(!empty($bill ->bill_client_name))
                    {{$bill ->bill_client_name ?? ''}} /  {{$bill ->bill_client_phone ?? ''}} 
                  @endif
...
<a href="{{route('oldEntryAll')}}" class="no-print btn btn-md btn-danger"
