...
<button onclick="window.print();" class="no-print btn btn-md btn-info">اضغط للطباعة</button>
<a href="https://wa.me/{{$bill ->client_phone}}/?text=urlencodedtext" class="no-print btn btn-md btn-success"
   style="left:250px!important;">
    ارسال الفاتورة واتس اب
</a>
<a href="{{route('pos_sales')}}" class="no-print btn btn-md btn-danger"
   style="left:460px!important;">
    العودة الى النظام
</a>
