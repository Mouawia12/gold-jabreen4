                ...
                <div class="card-header pb-0" id="head-right" >
                    <div class="col-lg-12 margin-tb text-center">
                        <h4  class="alert alert-primary text-center">
                           {{__('سندات القبض نقدية وذهب')}}
                        </h4> 
                    </div> 
                </div>  
                <div class="col-lg-12 margin-tb text-center">
                    @can('اضافة سند قبض')     
                        <a  href="{{route('admin.CatchGoldRecipts.create')}}" type="button" class="btn btn-labeled btn-info ">
                                   ...
                                   style="text-align: center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> {{__('ذهب عيار 24(جرام)')}} </th>
                                            <th> {{__('ذهب عيار 21(جرام)')}} </th>
                                            <th> {{__('ذهب عيار 18(جرام)')}} </th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                               @can('اضافة فاتورة ضريبية')  
                                                    @if($bill->sale_id == 0)
                                                    <a href="{{route('pos.create.gold.recipts',$bill -> id)}}" type="button" class="btn btn-labeled btn-primary">
                                                        <i class="fa fa-plus"></i> 
                                                        فاتورة بيع (تحت التصنيع)
                                                    </a>
                                                    @endif
                                                @endcan  
                                               @can('عرض سند قبض') 
