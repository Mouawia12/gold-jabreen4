                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form method="POST" action="{{ route('store.pos.collectible') }}"
                                    ...
                                    <div class="card shadow mb-4 col-9">
                                            ...
                                            <div class="row">
                                               <div class="col-12"> 
                                                    <h4  class="alert alert-primary text-center">
                                                      [ فاتورة مبيعات  ضريبية -  مقتنيات ثمينة ]
                                                    </h4> 
                                                </div> 
                                            </div>  
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <label style="float: right;">{{ __('main.bill_number') }}  
                                                        </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6" id="bill_client_name">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-6 " hidden>
                                                    <div class="form-group">
                                                        <label style="float: right;">{{ __('main.document_type') }}  
                                                        </label>
                                                        <select class="form-control"
                                                                name="document_type" id="document_type">
                                                            <option value="1" >فاتورة ضريبية مبسطة</option>
                                                            <option value="2" >فاتورة ضريبية شركات</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>   
                                                           ...
                                                           <div class="card-header pb-0">
                                                            ...
                                                            <div class="card-body px-0 pt-0 pb-2">
                                                                <div class="table-responsive p-0">
                                                                    <table id="sTable"
                                                                           class="display w-100 table-bordered text-center">
                                                                        <thead>
                                                                            <tr> 
                                                                                <th class="col-md-3">{{__('main.item')}}</th>
                                                                                <th hidden>{{__('main.karat')}}</th>
...
<script type="text/javascript">
            ...
            if(client > 0 ) {
                if (rows > 0){
                    if (net_after_discount > 0) {
                        ...
                        alert($('<div>{{trans('لا يجب ان تكون قيمة الفاتورة صفر')}}</div>').text());
                    }
                } else {
    ...
    function getBillNo() {
        ...
        $.ajax({
            type: 'get',
            url: 'get_sales_pos_collectible_no/' + type+ '/' + branch_id,
            dataType: 'json',
    ...
    function searchProduct(code) {
        ...
        $.ajax({
            type: 'get',
            url: 'getProductCollectible/' + code + '/' + branch_id,
            dataType: 'json',
    ...
    function loadItems() {
        ...
        $.each(sItems, function (i, item) {
            ...
            var tr_html ='<td class="text-center"><input type="hidden" name="item_id[]" value="' + item.id + '"> <strong>' + item.name_ar + '</strong><br>' + (item.code) + '</span> </td>';
            tr_html +='<td hidden><input type="hidden"  class="form-control iNewkarat" name="karat_id[]" value="' + item.karat_id + '"> <span>' + item.karat.name_ar + '</span> </td>';
            tr_html += '<td><input type="text"   class="form-control iNewWeight" name="weight[]" value="' + item.weight + '" ></td>';
            tr_html += '<td hidden><input type="hidden"   class="form-control iNewPrice" name="gram_price[]" value="' + item.price.toFixed(2) + '" ></td>';
