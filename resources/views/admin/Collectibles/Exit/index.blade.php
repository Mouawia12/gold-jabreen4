            ...
            <div class="card">
                <div class="card-header pb-0" id="head-right" >
                    <div class="col-lg-12 margin-tb">
                        ...
                        [ قائمة المبيعات الضريبية - المقتنيات الثمينة ]
                        </h4>
                    </div>
                                   ...
                                   style="text-align: center;">
                                    ...
                                    @foreach($data as $bill)
                                        <tr>
                                            ...
                                            <td class="text-center">{{$bill -> branch_name}}</td> 
                                            ...
                                            <td class="text-center"> 
                                                @can('عرض فاتورة ضريبية')  
                                                <a href="{{route('Sale.Preview' , $bill -> id)}}" class="btn btn-primary" role="button" data-bs-toggle="button">
                                                ...
                                                @if($bill -> returned_bill_id == 0 && $bill -> net_money > 0)
                                                    ...
                                                    <a href="{{route('return.pos.Collectible' , $bill -> id)}}" class="btn btn-info" role="button" data-bs-toggle="button">
...
<script type="text/javascript">
    ...
    let id = 0;
    document.title = "قائمة مبيعات المقتنيات الثمينة";
