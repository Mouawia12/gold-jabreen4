                ...
                <div class="card-header pb-0" id="head-right" >
                    <div class="col-lg-12 margin-tb">
                        <h4  class="alert alert-primary text-center">
                            مردود مبيعات ضريبية - مقتنيات ثمينة
                        </h4>
                    </div>
                                   ...
                                   style="text-align: center;">
                                    ...
                                    @foreach($data as $bill)
                                        <tr>
                                            ...
                                            <td class="text-center">{{$bill -> total_money + $bill -> tax }}</td>
                                            <td class="text-center">{{$bill -> total_money }}</td>
                                            <td class="text-center">{{$bill -> discount}}</td>
                                            <td class="text-center">{{$bill -> tax}}</td> 
                                            <td class="text-center"> 
                                                    @can('عرض مرتجع فاتورة مبيعات')    
                                                    <a class="btn btn-info editBtn" href="{{route('sale.Return.Preview.Collectible' , $bill -> id)}}" role="button" value="{{$bill -> id}}">
...
<script type="text/javascript">
    let id = 0;
    document.title = "{{__('مردود مبيعات مقتنيات ثمينة')}}";
