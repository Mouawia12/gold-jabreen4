                ...
                <div class="card-header pb-0" id="head-right" >
                    <div class="col-lg-12 margin-tb">
                        <h4  class="alert alert-primary text-center">
                            مردود فاتورة مبيعات ضريبية - مقتنيات ثمينة
                        </h4>
                    </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form method="POST" action="{{ route('return.sale.post.Collectible') }}"
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="card mb-4">
                                                        <div class="card-header pb-0">
                                                            <h6  class="alert alert-info text-center"> 
                                                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> {{__('main.items')}} 
                                                            </h6>
                                                        </div>
                                    ...
                                    <div class="card shadow mb-4 col-3">
                                        <div class="card-header py-3">
                                            <h6 class="alert alert-info text-center">{{__('main.sales_invoice_total')}}</h6>
                                        </div>
                                        <div class="card-body ">
