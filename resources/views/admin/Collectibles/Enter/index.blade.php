                                   ...
                                   style="text-align: center;direction: rtl;">
                                    ...
                                    @foreach($data as $bill)
                                        <tr>
                                            ...
                                            @can('عرض اوامر التوريد')
                                                <a class="btn btn-info editBtn" href="{{route('Purchase.Enter.Print' , $bill -> id)}}" role="button">
...
<script type="text/javascript">
    let id = 0;
    document.title = " مشتريات المقتنيات الثمينة";
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#createButton', function (event) {  
            @can('اضافة فاتورة مشتريات')
                window.location = "{{route('Purchase.Entry.Create')}}";
            @endcan
        });
