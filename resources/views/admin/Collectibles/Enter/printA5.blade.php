...
<head>
    <title>
        فاتورة مشتريات -  مقتنيات ثمينة  {{$bill -> bill_number}}
    </title>
    <meta charset="utf-8"/>
    ...
    <div class="above-table w-50 text-center mt-3  justify-content-center" style="margin: 10px auto!important;">
        ...
        <table style="width: 100% ; direction: rtl" class="table-bordered"> 
                ...
                <tr>
                    ...
                    <th class="text-center " style="width: 20%">الصنف
                        <br>(Karat)</th>
                ...
                <tr>
                    <td class="text-center" colspan="3"> اجمالي الخصم</td>
                    <td class="text-center">{{$bill -> discount}}</td>
                </tr>
                <tr>
                    <td class="text-center" colspan="3"> اجمالي الضريبة</td>
                    <td class="text-center">{{$bill -> tax}}</td>
                </tr>
                <tr>
                    <td class="text-center" colspan="2">  صافي النقدية</td>
                    <td class="text-center" colspan="1">  فقط لاغير  </td>
