            ...
            <div class="card">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="card shadow mb-4"> 
                        <div class="card-body">
                            <form   method="POST" action="{{ route('purchase.return.search.report') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                            <label>{{ __('نوع المشتريات') }} <span style="color:red; font-size:20px; font-weight:bold;">*</span> </label> 
                                                <select name="type" id="type"  class="js-example-basic-single w-100" required>
                                                    <option value="4">عام</option>
                                                    <option value="3">مشغول</option>
                                                    <option value="2">صافي</option>
                                                    <option value="0">كسر</option>
                                                </select>  
