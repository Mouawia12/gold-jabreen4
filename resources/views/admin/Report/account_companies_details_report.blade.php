                           ...
                           style="text-align: center;direction: rtl;">
                            ...
                            @foreach($accounts as  $unit)
                                <tr>  
                                    ...
                                    <td class="text-center">{{(float) $unit->debit_K18}}</td>
                                    <td class="text-center">{{(float) $unit->credit_K18}}</td>
                                    <td class="text-center">{{(float) $unit->debit_K21}}</td>
                                    <td class="text-center">{{(float) $unit->credit_K21}}</td>
                                    <td class="text-center">{{(float) $unit->debit_K24}}</td>
                                    <td class="text-center">{{(float) $unit->credit_K24}}</td>  
                                    @else
                                    <td class="text-center">0</td>
                                    <td class="text-center">0</td>
                                    <td class="text-center">0</td>
                                    ...
                                    @php   
                                        ...
                                        if($basedon_no <> $unit->basedon_no)
                                        {
                                            ...
                                            $k18_debit += ((float) $unit->debit_K18 ); 
                                            $k21_debit += ((float) $unit->debit_K21 ) ; 
                                            $k24_debit += ((float) $unit->debit_K24 ); 

                                            $k18_credit +=  ((float) $unit->credit_K18 );  
                                            $k21_credit +=  ((float) $unit->credit_K21 );  
                                            $k24_credit +=  ((float) $unit->credit_K24 ); 
