            ...
            <div class="card">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="card shadow mb-4"> 
                        <div class="card-body">
                            <form   method="POST" action="{{ route('sales.return.search.report') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                            <label>{{ __('المستخدم') }} <span class="text-danger">*</span></label> 
                                                <select name="user_id" id="user_id" class="js-example-basic-single w-100" required>
                                                   <option value="0">الكل</option>
                                                    @foreach($users as $row)
                                                        <option value="{{$row->id}}">{{$row->name }} - {{$row->branch->branch_name ?? ''}}</option>
                                                    @endforeach
                                                </select>  
