                    ...
                    <table class="table table-bordered" id="sTable" width="100%" cellspacing="0">
                        ...
                        @foreach($data as $item)
                            ...
                            @php
                                ...
                                $total_made_Value += ($item -> weight * $item -> made_Value);
                            @endphp
                        @endforeach
                        </tbody> 
                        <tfoot> 
                            <tr>
                                <th class="text-center" colspan="4">الاجمالي</th>
                                ...
                                <th class="text-center">
                                    <input type="text" id="total_made_Value" name="total_made_Value"
                                       class="form-control text-center" readonly
                                       @if($total_made_Value > 0) 
                                       value="{{ round($total_made_Value / $total_weight,2) }}" @endif
                                        />
...
<script type="text/javascript"> 
    ...
    var IsRow = 0;
    var total_weight = 0;
    var total_made_Value = 0;
    document.title = "تجميع طقم";

    $(document).ready(function () {  
        
        total_weight = $("#total_weight").val() ;
        total_made_Value = $("#total_made_Value").val() ;
        ...
        $(document).on('click', '.deleteBtn', function (event) { 
            ...
            var old_made_Value = 0; 
            var new_made_Value = 0; 
            IsRow -= 1

            old_made_Value = (Number(total_weight) * Number(total_made_Value));
            new_made_Value = (Number(sItems[item_id].weight) * Number(sItems[item_id].made_Value));

            total_weight =  (Number(total_weight) - Number(sItems[item_id].weight)).toFixed(2);
            total_made_Value = ((Number(old_made_Value) - Number(new_made_Value)) / Number(total_weight)).toFixed(2);
 
            $("#total_weight").val(total_weight);
            $("#total_made_Value").val(total_made_Value);
        ...
        function loadItems(item) {  
            ...
            old_made_Value = (Number(total_weight) * Number(total_made_Value));
            new_made_Value = (Number(item.weight) * Number(item.made_Value));

            total_weight =  (Number(total_weight) + Number(item.weight)).toFixed(2);
            total_made_Value = ((Number(old_made_Value) + Number(new_made_Value)) / Number(total_weight)).toFixed(2);
