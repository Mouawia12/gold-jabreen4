...
<body id="barcode_item" style="direction: rtl;width: 75mm;margin-top: 0;padding-left: 0;padding-right: 0;margin-right: 0;position: absolute;top: 0;right: 0;">
<div class="row" style="width:45mm; display: flex ; " >
    ...
    <div class="col-6 text-center" style="width: 22.5mm; height: 13mm;">
        ...
        <label style="  width: 20mm; height: 5mm ; margin: 0 auto; display:block ; text-align: center; font-size:9px;font-weight:700;">{{$company->name_ar}}</label>
