...
class CreateSystemSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('system_settings', function (Blueprint $table) {
            ...
            $table->double('img_width')-> default(0) -> nullable();
            $table->double('img_height')-> default(0) -> nullable();
            $table->double('small_img_width')-> default(0) -> nullable();
            $table->double('small_img_height')-> default(0) -> nullable();
            ...
            $table->integer('qnt_double_point')->default(0) -> nullable();
            $table->integer('double_type')->default(0) -> nullable();
            ...
            $table->integer('a4_double_point')->default(0) -> nullable();
            ...
            $table->double('weight_divider')->default(0) -> nullable();
            ...
            $table->double('client_value')->default(0) -> nullable();
            $table->double('client_points')->default(0) -> nullable();
            $table->double('employee_value')->default(0) -> nullable();
            $table->double('employee_points')->default(0) -> nullable();
            $table->integer('is_tobacco')->default(0) -> nullable();
            $table->double('tobacco_tax')->default(0) -> nullable();
