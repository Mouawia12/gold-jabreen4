...
class PurchaseController extends SiteController
{
    ...
    public function show($id)
    {
        ...
        if(count($datas)){
            ...
            return view('admin.purchases.view',compact('data' , 'details','vendor'))->render();
        }
    ...
    public function edit($id)
    {
       ...
       // return  $purchaseItems ;
        return view('admin.purchases.edit',compact('warehouses','customers','purchaseItems','id','purchase'));
