...
class ZATCASimplifiedTaxInvoiceController extends Controller
{
    ...
    {
        $this->templates = new XmlTemplateController();
    }
    ...
    public function simplifiedTaxInvoice(array $invoice, array $egs_unit)
    {
        ...
        $populated_template = str_replace('SET_CUSTOMER', $invoice['customer_name'], $populated_template);
        ...
        //$document->formatOutput = true; // set the formatOutput attribute of domDocument to true
        // save XML as string or file 
        //$invoce1 = $document->saveXML(); // put string in test1

        //$document->save($invoice['invoice_serial_number'].'.xml'); // save as file
        return $document;
    }
